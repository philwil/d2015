...
/* 
   SDCS 18052011
   anomalies 432 and 171 are NOT present on the 527 0.2 so we do not
   have to worry about setting SIC_IWR1 and triggering 435 , at least under uboot 
   the last write to SIC_IWR1 leaves it in the default state of all 1's 
   so we should be OK
*/
