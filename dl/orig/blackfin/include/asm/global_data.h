...
typedef struct global_data {
	...
	phys_size_t ram_size;		/* RAM size */
     unsigned long reloc_off;        /* Relocation Offset */		/* addedon 120712 by Alex. To match with uclinux (include/asm-blackfin/u_boot.h) */
	...
	void **jt;		/* jump table */
        unsigned long nmi_addr; /* Address of nmi_data  */
} gd_t;
