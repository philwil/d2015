...
# define CONFIG_BFIN_SCRATCH_REG CYCLES 
#endif
...
/* # define CONFIG_SYS_GBL_DATA_SIZE (1024)  280612 */
#endif
...
/* #define CONFIG_MIN_DELTA_ADDRESS 0x01e00000 in bf527-ezkit.h */


/* check that Delta requirements are also met */
#if CONFIG_SYS_MONITOR_BASE < CONFIG_MIN_DELTA_ADDRESS
# error Memory Map Exceeds CONFIG_MIN_DELTA_ADDRESS please adjust CONFIG_SYS_MONITOR_LEN
#endif
...
# define CONFIG_SYS_BOOTM_LEN 0x4000000	/* see cmd_bootm.c */
#endif
#ifndef CONFIG_SYS_PROMPT
# define CONFIG_SYS_PROMPT "uboot_r6_6> "	/* modified oct 11 2011. changed to _6 280612 */
#endif
