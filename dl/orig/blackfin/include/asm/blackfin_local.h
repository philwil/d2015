...
extern void blackfin_icache_flush_range(const void *, const void *) __attribute__ ((__l1_text__ , longcall));	// added attributes ano491. 160812. Alex
extern void blackfin_dcache_flush_range(const void *, const void *) __attribute__ ((__l1_text__ , longcall));
extern void blackfin_icache_dcache_flush_range(const void *, const void *) __attribute__ ((__l1_text__ , longcall));
extern void blackfin_dcache_flush_invalidate_range(const void *, const void *) __attribute__ ((__l1_text__ , longcall));

//extern void blackfin_dcache_invalidate_range(const void *, const void *) __attribute__ ((__l1_text__ , longcall));
